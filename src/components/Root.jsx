...
function Root() {
  ...
  return (
    <>
      <Header />
      <main className="flex md:mt-[230px]  flex-col gap-[24px] md:flex-row md:max-w-[1110px] md:items-center mx-auto md:gap-[50px] md:pb-[32px]">
        <Image />
        <SwitchImage />
        <Content />
      </main>
      ...
      <dialog
        id="img"
        className="w-[450px]     text-white relative  rounded-[10px]  bg-transparent"
      >
        <div className="flex flex-col gap-[10px]">
          <button onClick={() => imgClose()} className="flex justify-end mr-2 ">
            <svg
          ...
          <div className="w-full flex flex-col relative gap-[35px] items-center ">
            <div className="absolute top-[210px]   w-full flex justify-between items-center">
              <button
                onClick={previously}
                className="w-[56px] h-[56px] hover:opacity-[0.7] rounded-[999px] bg-white flex justify-center items-center"
              >
              ...
              <button
                onClick={next}
                className="w-[56px] h-[56px] hover:opacity-[0.7] ml-5 rounded-[999px] bg-white flex justify-center items-center"
              >
